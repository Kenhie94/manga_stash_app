          ...
          <div v-if="mangaDetails">
            <div class="d-flex p-3">
              ...
              <div class="d-flex flex-column">
                ...
                <h2 class="d-flex ps-4" v-for="manga in mangaDetails.attributes.altTitles" :key="manga">{{ manga.en }}
                </h2>
...
export default {
  ...
  data() {
    return {
      mangaDetails: null,
      coverUrlId: this.$route.params.id,
    };
  },
  mounted() {
  ...
  methods: {
    async saveManga() {
      try {
        ...
        await axios.post('Back_End/api/storeDB.js', this.coverUrlId);
